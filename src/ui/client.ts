        ...
        h('div', { className: 'osubs-acct-head' },
          h('div', { className: 'osubs-acct-main' },
            h('div', { className: 'osubs-acct-row' },
              ...
              (id === 'cursor' || id === 'ollama' || id === 'kimi' || id === 'copilot' || id === 'devin') && row.methodLabel && h('span', { className: 'osubs-tag' }, row.methodLabel),
      ...
      return h('section', { className: 'osubs-card' },
        ...
        id !== 'glm' && id !== 'kiro' && id !== 'ollama' && id !== 'opencode-go' && !busy && h('div', { className: 'osubs-logins' },
          ...
          h('button', {
            ...
            h('span', null, id === 'cursor' ? t.cursorImport : id === 'kimi' ? t.kimiImport : id === 'copilot' ? t.copilotImport : id === 'devin' ? t.devinImport : t.import),
          ),
        ),
        ...
        id === 'devin' && showKey && !busy && h('form', {
          ...
          h('div', { className: 'osubs-actions' },
            h(Button, { type: 'submit', variant: 'primary', label: t.devinKeyGo }),
          ),
        ),
