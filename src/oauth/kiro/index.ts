...
export const KIRO_MODELS = Object.freeze([
  { id: 'claude-sonnet-4.5', name: 'Claude Sonnet 4.5', contextWindow: KIRO_CONTEXT_WINDOW, maxTokens: KIRO_MAX_TOKENS, input: Object.freeze(['text', 'image']) },
  { id: 'claude-sonnet-4-8', name: 'Claude Sonnet 4.8', contextWindow: KIRO_CONTEXT_WINDOW, maxTokens: KIRO_MAX_TOKENS, input: Object.freeze(['text', 'image']) },
  { id: 'claude-opus-4.6', name: 'Claude Opus 4.6', contextWindow: KIRO_CONTEXT_WINDOW, maxTokens: KIRO_MAX_TOKENS, input: Object.freeze(['text', 'image']) },
])
