...
`;
        ...
        function ModelFamily({ t, group, onToggle, onFamily, onOpenFamily }) {
            ...
            return h('div', { className: `osubs-family${locked ? ' osubs-family--locked' : ''}` }, h('div', { className: 'osubs-family-head' }, h('div', { className: 'osubs-family-meta' }, h('h4', { className: 'osubs-family-title' }, group.displayName), h('span', { className: 'osubs-note' }, fill(t.modelsOn, `${enabledCount} / ${models.length}`)), locked && h('span', { className: 'osubs-note' }, `· ${t.modelsNeedLogin}`)), locked
        ...
        function ModelPicker({ t, catalog, onToggle, onFamily, onOpenFamily }) {
            ...
            if (groups.length === 0)
                return null;
            return h('section', { className: 'osubs-card' }, h('header', { className: 'osubs-card-head' }, h('div', { className: 'osubs-card-lede' }, h('h3', { className: 'osubs-card-title' }, t.modelsTitle), h('p', { className: 'osubs-hint' }, t.modelsHint)), h('span', { className: 'osubs-badge' }, fill(t.modelsOn, `${enabled} / ${total}`))), groups.map((group) => h(ModelFamily, { t, group, onToggle, onFamily, onOpenFamily, key: group.provider })));
        }
        ...
        function AboutPanel({ t, local, update, busy, applying, onCheck, dshLocal, dshUpdate, dshBusy, dshApplying, onDshCheck, autoUpdate, onAutoUpdate, }) {
            ...
            const pluginCard = h('section', { className: 'osubs-card' }, h('header', { className: 'osubs-card-head' }, h('h3', { className: 'osubs-card-title' }, t.pluginAboutTitle || t.aboutTitle), h('div', { className: 'osubs-about-actions' }, h(HoldTip, { label: t.autoUpdate }, h('label', { className: 'osubs-auto' }, h('input', {
                type: 'checkbox',
            ...
            const dshCard = h('section', { className: 'osubs-card' }, h('header', { className: 'osubs-card-head' }, h('h3', { className: 'osubs-card-title' }, t.dshTitle), h('div', { className: 'osubs-about-actions' }, h(HoldTip, { label: t.autoUpdate }, h('label', { className: 'osubs-auto' }, h('input', {
                type: 'checkbox',
