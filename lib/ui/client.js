...
`;
        ...
        function QuotaRow({ t, row, family }) {
            ...
            return h('div', { className: 'osubs-qrow' }, h('div', { className: 'osubs-qrow-head' }, h('span', { style: { color: 'var(--osubs-muted)' } }, rowLabel(row, t, family)), h('span', { style: { color, fontWeight: 500 } }, amount ? `${amount} · ` : '', caption)), percent !== undefined && h('div', { className: 'osubs-bar' }, h('i', {
                style: {
                    background: color,
