...
`;
        ...
        function AboutPanel({ t, local, update, busy, applying, onCheck, dshLocal, dshUpdate, dshBusy, dshApplying, onDshCheck, autoUpdate, onAutoUpdate, }) {
            ...
            })))), h('div', { className: 'osubs-about' }, h('div', { className: 'osubs-kv' }, h('div', { className: 'osubs-kv-row' }, h('span', null, t.dshRepo), h('a', { className: 'osubs-link', href: dshRepo + '/tags', target: '_blank', rel: 'noreferrer' }, dshSlug)), h('div', { className: 'osubs-kv-row' }, h('span', null, t.dshInstalled), h('span', null, dshVersion)), dshTag?.tag && h('div', { className: 'osubs-kv-row' }, h('span', null, t.dshLatestTag), h('a', { className: 'osubs-link', href: dshTag.url, target: '_blank', rel: 'noreferrer' }, dshTag.tag)), dshNpm?.version && h('div', { className: 'osubs-kv-row' }, h('span', null, t.dshNpmVersion), h('a', {
                className: 'osubs-link',
                href: 'https://www.npmjs.com/package/' + (dshEffective?.npmPackage || '@deepseek-ai/dsh') + '/v/' + dshNpm.version,
                target: '_blank',
                rel: 'noreferrer',
            }, dshNpm.version)), dshVersionOptions.length > 0 && h('div', { className: 'osubs-kv-row' }, h('span', null, t.dshPickVersion), h('div', { className: 'osubs-version-pick' }, h('select', {
            ...
            })))), dshTag?.publishedAt && h('p', { className: 'osubs-note' }, fill(t.dshTagPublished, dshTag.publishedAt)), dshHint && h('p', { className: 'osubs-hint' + (dshTone ? ' ' + dshTone : '') }, dshHint), dshApply && h('p', { className: 'osubs-hint' + (dshApplyTone ? ' ' + dshApplyTone : '') }, dshApply))));
