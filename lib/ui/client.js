...
`;
        ...
        function ProviderCard({ t, id, title, account, pending, onLogin, onImport, onLogout, onCancel, onManual, onSwitch, onRefreshQuota, onResetQuota, onUseKey }) {
            ...
            return h('section', { className: 'osubs-card' }, h('header', { className: 'osubs-card-head' }, h('h3', { className: 'osubs-card-title' }, title), h('span', {
                ...
                onClick: () => onLogin(id),
            }, h('span', null, id === 'grok' || id === 'kimi' ? t.device : loggedIn ? t.addAccount : t.login)), id === 'grok' && h('button', {
                type: 'button',
                className: 'osubs-login',
            ...
            }, h('span', null, t.kimiLoginApiKey)), h('button', {
                type: 'button',
                className: 'osubs-login osubs-login-ghost',
                onClick: () => { onImport(id); closeAdd(); },
            }, h('span', null, id === 'cursor' ? t.cursorImport : id === 'kimi' ? t.kimiImport : t.import))), id === 'kimi' && showKey && !busy && h('form', {
                ...
                autoComplete: 'off',
            }), h('p', { className: 'osubs-hint' }, t.kimiKeyHint), h('div', { className: 'osubs-actions' }, h(Button, { type: 'submit', variant: 'primary', label: t.kimiKeyGo }))), id === 'ollama' && !busy && h('div', { className: 'osubs-logins' }, h('button', {
                type: 'button',
                className: 'osubs-login',
                onClick: () => setShowKey((open) => !open),
