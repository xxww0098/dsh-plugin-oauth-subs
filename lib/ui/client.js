...
`;
        ...
        // https://unpkg.com/@lobehub/icons-static-svg@1.94.0/icons/{codex,grok,zai,kiro,github}.svg
        const TAB_ICONS = {
        ...
        function ProviderCard({ t, id, title, account, pending, onLogin, onImport, onLogout, onCancel, onManual, onSwitch, onRefreshQuota, onResetQuota, onUseKey }) {
            ...
            }), h('p', { className: 'osubs-hint' }, t.kiroRefreshHint), h('div', { className: 'osubs-actions' }, h(Button, { type: 'submit', variant: 'primary', label: t.kiroRefreshGo }))), busy && pending?.mode === 'pkce' && h('form', {
                onSubmit: (event) => {
                    event.preventDefault();
                    onManual(id, paste);
                },
