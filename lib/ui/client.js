...
`;
        ...
        function ModelFamily({ t, group, onToggle, onFamily, onOpenFamily }) {
            ...
            return h('div', { className: `osubs-family${locked ? ' osubs-family--locked' : ''}` }, h('div', { className: 'osubs-family-head' }, h('div', { className: 'osubs-family-meta' }, h('h4', { className: 'osubs-family-title' }, group.displayName), h('span', { className: 'osubs-note' }, fill(t.modelsOn, `${enabledCount} / ${models.length}`))), locked
