    ...
    factory: (require) => {
        ...
        const COPY = {
            zh: {
                ...
                kiroLoginRefresh: '粘贴 refresh token',
                ...
                kiroRefreshPlaceholder: 'Social / OAuth refresh token',
                kiroRefreshHint: '粘贴完整的 Kiro IDE Social refresh token。截断的（含 … 或过短）会被拒绝。',
                kiroKeyGo: '保存密钥',
                kiroRefreshGo: '保存 token',
                switchTo: '切换',
                inUse: '使用中',
                noAccounts: '还没有登录账号',
                pkce: 'PKCE 登录',
            ...
            en: {
                ...
                kiroLoginRefresh: 'Paste refresh token',
                kiroStartUrl: 'Start URL',
                kiroStartUrlPlaceholder: 'https://d-xxxxxxxxxx.awsapps.com/start',
                ...
                kiroRefreshPlaceholder: 'Social / OAuth refresh token',
                kiroRefreshHint: 'Paste the full Kiro IDE Social refresh token. Truncated tokens (… or too short) are rejected.',
                kiroKeyGo: 'Save key',
                kiroRefreshGo: 'Save token',
                switchTo: 'Switch',
                inUse: 'In use',
