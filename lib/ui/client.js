...
`;
        ...
        function ApiKeyPanel({ t, go, onSave, onClear, onRefreshQuota }) {
            ...
            })), h('div', { className: 'osubs-actions' }, h(Button, { variant: 'primary', disabled: busy, label: t.opencodeGoSave, onClick: save }), configured && h(Button, { size: 'sm', disabled: busy, label: t.opencodeGoClear, onClick: () => clear('cookie') }), go?.workspaceId && h(Button, { size: 'sm', disabled: busy, label: t.opencodeGoClearWorkspace, onClick: () => clear('workspace') })), message && h('p', { className: 'osubs-hint' }, message), h(QuotaBlock, { t, family: 'opencode-go', quota: go?.quota, onRefresh: onRefreshQuota }));
        }
