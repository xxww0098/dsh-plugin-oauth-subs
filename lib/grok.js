 ...
 *
 * Client id and OIDC issuer come from Hermes Agent / Grok CLI
 * (`b1a00492-073a-47ea-816f-4c329264a828`, https://auth.x.ai). Hermes prefers
 * RFC 8628 device-code (no loopback); PKCE on 127.0.0.1:56121 is the fallback
 * used by Grok Build CLI.
 */
...
export const GROK_MODELS = Object.freeze([
  { id: 'grok-4.6', name: 'Grok 4.6', contextWindow: GROK_CONTEXT_WINDOW, maxTokens: GROK_DEFAULT_MAX_TOKENS },
  { id: 'grok-4.5', name: 'Grok 4.5', contextWindow: GROK_CONTEXT_WINDOW, maxTokens: GROK_DEFAULT_MAX_TOKENS },
  { id: 'grok-4', name: 'Grok 4', contextWindow: GROK_CONTEXT_WINDOW, maxTokens: GROK_DEFAULT_MAX_TOKENS },
])
