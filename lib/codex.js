...
/** GPT-5.5 and older: no `max`. */
export const CODEX_REASONING_EFFORTS = Object.freeze({
  off: null,
  ...CODEX_REASONING,
})

/** GPT-5.6 Sol / Terra / Luna accept `max`. */
...
export const CODEX_MODELS = Object.freeze([
  { id: 'gpt-5.6-sol', name: 'GPT-5.6 Sol', contextWindow: CODEX_CONTEXT_WINDOW, maxTokens: CODEX_DEFAULT_MAX_TOKENS, reasoningEfforts: CODEX_REASONING_EFFORTS_56 },
  { id: 'gpt-5.6-terra', name: 'GPT-5.6 Terra', contextWindow: CODEX_CONTEXT_WINDOW, maxTokens: CODEX_DEFAULT_MAX_TOKENS, reasoningEfforts: CODEX_REASONING_EFFORTS_56 },
  { id: 'gpt-5.6-luna', name: 'GPT-5.6 Luna', contextWindow: CODEX_CONTEXT_WINDOW, maxTokens: CODEX_DEFAULT_MAX_TOKENS, reasoningEfforts: CODEX_REASONING_EFFORTS_56 },
  { id: 'gpt-5.5', name: 'GPT-5.5', contextWindow: CODEX_CONTEXT_WINDOW, maxTokens: CODEX_DEFAULT_MAX_TOKENS, reasoningEfforts: CODEX_REASONING_EFFORTS },
  { id: 'gpt-5.4', name: 'GPT-5.4', contextWindow: CODEX_CONTEXT_WINDOW, maxTokens: CODEX_DEFAULT_MAX_TOKENS, reasoningEfforts: CODEX_REASONING_EFFORTS },
  ...
  { id: 'gpt-5.3-codex', name: 'GPT-5.3 Codex', contextWindow: CODEX_CONTEXT_WINDOW, maxTokens: CODEX_DEFAULT_MAX_TOKENS, reasoningEfforts: CODEX_REASONING_EFFORTS },
  { id: 'gpt-5.3-codex-spark', name: 'GPT-5.3 Codex Spark', contextWindow: CODEX_CONTEXT_WINDOW, maxTokens: CODEX_DEFAULT_MAX_TOKENS, reasoningEfforts: CODEX_REASONING_EFFORTS },
])
