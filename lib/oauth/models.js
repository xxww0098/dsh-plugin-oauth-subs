...
import { OPENCODE_GO_BUILTIN_ROUTE_ID, OPENCODE_GO_EXTRA_ROUTE, OPENCODE_GO_SESSION_HEADER, OPENCODE_GO_SESSION_ID, opencodeGoSessionHeaders, } from '../apikey/opencode-go/models.js';
...
function isPluginOpencodeGoBuiltin(existing) {
    ...
    if (keys.length === 1)
        return true;
    if (keys.length !== 2 || existing.headers == null || typeof existing.headers !== 'object')
        return false;
