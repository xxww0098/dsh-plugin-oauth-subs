...
import { buildProviders, catalogProviders, describeCatalog, describeProviders, ensureOpencodeGoRoute, filterProviders, ModelSwitch, syncHarnessModels, } from './models.js';
...
export class AuthController {
    ...
    async opencodeGoSnapshot(options) {
        if (!this.opencodeGo)
            return { id: 'opencode-go', cookieSet: false, workspaceId: '', configured: false, quota: { status: 'idle' } };
