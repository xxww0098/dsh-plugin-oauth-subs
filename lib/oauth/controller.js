...
import { fetchLatest, localUpdateInfo, applyHostUpdate, compareVersions, DEFAULT_PROFILE, fetchDshLatest, localDshInfo, applyHostDshUpdate, scheduleDshWebRestart, } from '../utils/update.js';
...
export class AuthController {
    ...
    async setAutoUpdate(payload = {}) {
        ...
        if (this.autoUpdate.plugin || this.autoUpdate.dsh)
