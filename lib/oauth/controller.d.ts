...
export declare class AuthController {
    #private;
    constructor({ authPath, prefix, origin, settings, grokLogin, onAuthChanged, models, fetchFn, quotaTtlMs, spawnFn, profile, cursorAutoImport, cursorImport, cursorDiscover }: {
        authPath: any;
        prefix: any;
        origin: any;
        settings: any;
