...
export function formatPlanLabel(raw, family) {
    ...
    if (family === 'opencode') {
        if (OPENCODE_PLAN_NAMES[slug])
            return OPENCODE_PLAN_NAMES[slug];
        if (OPENCODE_PLAN_NAMES[compact])
            return OPENCODE_PLAN_NAMES[compact];
    }
    if (family === 'copilot') {
    ...
    if (family !== 'glm' && family !== 'grok' && family !== 'kiro' && family !== 'antigravity' && family !== 'cursor' && family !== 'ollama' && family !== 'kimi' && family !== 'opencode' && family !== 'copilot') {
