  ...
  factory: (require) => {
    ...
    const COPY = {
      zh: {
        ...
        plan: '套餐',
        modelsTitle: '模型',
        modelsHint: '勾选要同步到 DeepSeek Harness 的模型。Fast 是 Priority Processing；900K 是大上下文，默认关闭。两者用量都更高。关闭后从模型列表移除。未登录的系列会在登录后生效。',
        modelsOn: '已开启 {n}',
        modelsAll: '全选',
        modelsNone: '全关',
      ...
      en: {
        ...
        plan: 'Plan',
        modelsTitle: 'Models',
        modelsHint: 'Enable models to sync into DeepSeek Harness. Fast is Priority Processing. 900K is the large Codex window (off by default). Both use more quota. Disabled models leave the picker. Families that are signed out apply on the next sign-in.',
        modelsOn: '{n} on',
        modelsAll: 'All on',
        modelsNone: 'All off',
