...
| Google Antigravity | `cloudcode-pa` `loadCodeAssist` + `fetchAvailableModels` (daily / sandbox / prod) | Plan badge (STANDARD TIER / Free / Pro …) plus SkillStar model-group remaining bars |
