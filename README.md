...
| Google Antigravity | daily-cloudcode-pa `loadCodeAssist` + `fetchAvailableModels` (prod only on 5xx / transport) | Plan badge (STANDARD TIER / Free / Pro …) plus SkillStar model-group remaining bars |
